...
class AutomatedDashboard:
    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            /* INSIGHTS GRID - estilo do index (4) */
            ...
            /* FILTERS SECTION - estilo do index (4) melhorado */
            ...
            /* Category toggles - do dashboard_violencia */
    ...
    <div class="dashboard">
        ...
        <div class="header">
            ...
            <div class="update-info">
                <div class="update-time"><i class="fas fa-clock"></i><span>Última atualização: 08/06/2026 às 12:43:56</span></div>
                <div>
        ...
        <!-- STATS GRID - estilo index (4) -->
        <div class="stats-grid">
            <div class="stat-card"><div class="icon"><i class="fas fa-gavel"></i></div><h3>⚖️ FEMINICÍDIO CONSUMADO</h3><div class="value" id="totalFem">7</div></div>
            <div class="stat-card"><div class="icon"><i class="fas fa-exclamation-triangle"></i></div><h3>⚠️ FEMINICÍDIO TENTADO</h3><div class="value" id="totalFemTent">21</div></div>
            <div class="stat-card"><div class="icon"><i class="fas fa-comment-dots"></i></div><h3>💬 AMEAÇAS</h3><div class="value" id="totalAmeaca">2.582</div></div>
            <div class="stat-card"><div class="icon"><i class="fas fa-shield-alt"></i></div><h3>🔞 ESTUPROS</h3><div class="value" id="totalEstupro">215</div></div>
            <div class="stat-card"><div class="icon"><i class="fas fa-heart-broken"></i></div><h3>💔 LESÕES CORPORAIS</h3><div class="value" id="totalLesao">1.668</div></div>
        </div>
    
        <!-- INSIGHTS GRID - estilo index (4) -->
        <div class="insights-grid">
            <div class="insight-card"><h4><i class="fas fa-chart-simple"></i> Média Anual</h4><div class="insight-value" id="mediaAnual">1.4</div><div class="insight-label">Feminicídios por ano</div></div>
            <div class="insight-card"><h4><i class="fas fa-trend-up"></i> Tendência</h4><div class="insight-value" id="tendencia">DECRESCENTE</div><div class="insight-label" id="tendenciaLabel">↓ Decrescente</div></div>
            <div class="insight-card"><h4><i class="fas fa-calendar"></i> Projeção 2026</h4><div class="insight-value" id="proj2026">1</div><div class="insight-label">Feminicídios estimados</div></div>
            <div class="insight-card"><h4><i class="fas fa-chart-pie"></i> Total Geral</h4><div class="insight-value" id="totalGeral">4.493</div><div class="insight-label">Casos registrados (2022-2026)</div></div>
        </div>
    
        <!-- FILTERS SECTION - combinando ambos -->
    ...
    <script>
    // DADOS - mesmos do index (4)
    const dadosIniciais = [
        {"ano": 2022, "feminicidio_consumado": 1, "feminicidio_tentado": 4, "ameaca": 603, "estupro": 50, "lesao_corporal": 420},
        {"ano": 2023, "feminicidio_consumado": 1, "feminicidio_tentado": 3, "ameaca": 571, "estupro": 58, "lesao_corporal": 417},
        {"ano": 2024, "feminicidio_consumado": 4, "feminicidio_tentado": 5, "ameaca": 553, "estupro": 39, "lesao_corporal": 380},
        {"ano": 2025, "feminicidio_consumado": 1, "feminicidio_tentado": 8, "ameaca": 650, "estupro": 53, "lesao_corporal": 345},
        {"ano": 2026, "feminicidio_consumado": 0, "feminicidio_tentado": 1, "ameaca": 205, "estupro": 15, "lesao_corporal": 106}
    ];
    
    const mesMaxDados = {"2022": 12, "2023": 12, "2024": 12, "2025": 12, "2026": 5};
    ...
    function renderTable() {
        ...
        for (const d of dados) {
            ...
            html += `<tr><td><strong>${d.ano}</strong>${d.ano === 2026 ? ' ⚠️' : ''}</td>
                    <td>${d.feminicidio_consumado}</td><td>${d.feminicidio_tentado}</td>
                    <td>${fmtNum(d.ameaca)}</td><td>${d.estupro}</td>
                    <td>${fmtNum(d.lesao_corporal)}</td>
                    <td><strong>${fmtNum(total)}</strong></td><td>${variacaoHtml}</td></tr>`;
            anteriorTotal = total;
        }
